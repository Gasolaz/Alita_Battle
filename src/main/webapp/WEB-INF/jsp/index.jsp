...
<header>
    ...
    <div class="container">
        ...
        <%--<div class="buttons">--%>
        <%--&lt;%&ndash;<button type="button" data-toggle="popover" data-target="#newContact" class="btn btn-primary"><span>Register</span></button>&ndash;%&gt;--%>
        <%----%>
        <%--</div>--%>

        <div class="buttons">
            <a href="" class="btn btn-primary" data-toggle="modal"
               data-target="#modalLoginForm"><span>Sign In</span></a>
            <a href="" class="btn btn-secondary" data-toggle="modal"
               data-target="#modalRegForm"><span>Sign Up</span></a>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-3">
                        ...
                        <div class="md-form mb-4">
                            ...
                            <label data-error="wrong" data-success="right" for="defaultForm-pass"><input type="checkbox"
                                                                                                         name="session"
                                                                                                         value="remember-me">Remember
                                me<br></label>
