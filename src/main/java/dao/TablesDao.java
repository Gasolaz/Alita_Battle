...
public class TablesDao implements ITablesDao {
    ...
    public void insertItem(int item_id, String item_name, int price, int attribute_id, String insertionSql) {
        try (Connection conn = dataSource.getConnection()) {
            PreparedStatement ps = conn.prepareStatement(insertionSql);
            ps.setInt(1, item_id);
            ps.setString(2, item_name);
            ps.setInt(3, price);
            ps.setInt(4, attribute_id);
            ps.executeUpdate();
    ...
    public void insertAttribute(int attribute_id, int str_val, int agi_val, int int_val, int def_val, int hp_val, String insertionSql) {
        try (Connection conn = dataSource.getConnection()) {
            PreparedStatement ps = conn.prepareStatement(insertionSql);
            ps.setInt(1, attribute_id);
            ps.setInt(2, str_val);
            ps.setInt(3, agi_val);
            ps.setInt(4, int_val);
            ps.setInt(5, def_val);
    ...
    public void createTables() {
        ...
        insertItem(1, "empty", 0, 1, INSERT_FIRST_HAND);
        insertItem(2,"club", 5, 2, INSERT_FIRST_HAND);
        insertItem(3, "dagger", 10, 3, INSERT_FIRST_HAND);
        insertItem(4, "short sword", 20, 4, INSERT_FIRST_HAND);
        insertItem(5, "long sword", 25, 5, INSERT_FIRST_HAND);
        insertItem(6, "mace", 20, 6, INSERT_FIRST_HAND);
        insertItem(7, "scimitar", 25, 7, INSERT_FIRST_HAND);
        insertItem(8, "two-handed sword", 35,8, INSERT_FIRST_HAND); //equipped on both hands
        insertItem(9, "shield", 10, 9, INSERT_FIRST_HAND);
        insertItem(10, "whip", 30, 10, INSERT_FIRST_HAND);
        insertItem(11, "magic staff", 20, 11, INSERT_FIRST_HAND);
        insertItem(12, "future item", 0, 12, INSERT_FIRST_HAND);
        insertItem(13, "future item", 0,13, INSERT_FIRST_HAND);
        insertItem(14, "future item", 0,14, INSERT_FIRST_HAND);
        insertItem(15, "future item", 0,15, INSERT_FIRST_HAND);
        insertItem(16, "future item", 0,16, INSERT_FIRST_HAND);
        insertItem(17, "future item", 0,17, INSERT_FIRST_HAND);
        insertItem(18, "future item", 0,18, INSERT_FIRST_HAND);
        insertItem(19, "future item", 0,19, INSERT_FIRST_HAND);

        //Items for 2nd hand (17 items - no 2h sword)
        insertItem(1, "empty", 0, 1, INSERT_SECOND_HAND);
        insertItem(2,"club", 5, 2, INSERT_SECOND_HAND);
        insertItem(3, "dagger", 10, 3, INSERT_SECOND_HAND);
        insertItem(4, "short sword", 20, 4, INSERT_SECOND_HAND);
        insertItem(5, "long sword", 25,5, INSERT_SECOND_HAND);
        insertItem(6, "mace", 20, 6, INSERT_SECOND_HAND);
        insertItem(7, "scimitar", 25, 7, INSERT_SECOND_HAND);
        insertItem(9, "shield", 10, 9, INSERT_SECOND_HAND);
        insertItem(10, "whip", 30, 10, INSERT_SECOND_HAND);
        insertItem(11, "future item", 0, 11, INSERT_SECOND_HAND);
        insertItem(12, "future item", 0, 12, INSERT_SECOND_HAND);
        insertItem(13, "future item", 0, 13, INSERT_SECOND_HAND);
        insertItem(14, "future item", 0, 14, INSERT_SECOND_HAND);
        insertItem(15, "future item", 0, 15, INSERT_SECOND_HAND);
        insertItem(16, "future item", 0, 16, INSERT_SECOND_HAND);
        insertItem(17, "future item", 0, 17, INSERT_SECOND_HAND);
        insertItem(18, "future item", 0, 18, INSERT_SECOND_HAND);
        insertItem(19, "future item", 0, 19, INSERT_SECOND_HAND);
